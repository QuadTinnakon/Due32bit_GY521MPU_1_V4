...
//ลงจอด
float waypoint1_LAT = 13.868180;//13.868544, 100.496433
float waypoint1_LON = 100.496297;//B,
//
...
float Altitude_Max = 10.0;//max 10 meter
//Parameter system Quadrotor
#define m_quad 1.16     //kg
#define L_quad 0.235   //m quad+=0.25   I = (1/3)mL2 = 0.02291
#define c_quad 0.00364 //N.s/m
#define arm_GPS 18.3 //17 cm
/////////////////////////////////////////////////////////////////////
//P-PID-------------Rate
float Kp_rateRoll = 1.92;//2.42 2.78 1.18 5.28
float Ki_rateRoll = 0.12;//1.12 2.75
float Kd_rateRoll = 0.045;//0.035 0.075 0.15 0.085 0.025 - 0.045

float Kp_ratePitch = 1.92;//2.42 1.18 5.28
float Ki_ratePitch = 0.12;//1.12 2.75 0.5 - 2.8
float Kd_ratePitch = 0.045;//0.075 0.15 0.078 0.025 - 0.045

float Kp_rateYaw = 2.75;//2.75 3.75 5.75 1.75 - 3.450  350.0
float Ki_rateYaw = 1.25;//1.85 3.65  2.95
float Kd_rateYaw = 0.065;//0.095 0.035 0.065
...
float Kp_altitude = 180.2;//155.2 225.2 265.2  175.0  165.0
float Ki_altitude = 11.45;//2.1 12.25 52.13 2.13 0.018 2.5,0.0
float Kd_altitude = 235.2;//210.2 185.2 195.2 185.2 250 280.5 315.5 120
float Kd2_altitude = 23.4;//35.25 18.25 22.25 42.5 12.2 1.25
float Ka_altitude = 0;//8.5 18.5 26 32.5 38.5 41.5 35 25 - 45

//////////////////RC//////////////////////////////////
//#define tarremote 0.025 // fast
//#define tarremote 0.062  //0.092 slow 0.12 0.02 0.08 remote 
#define tar 0.011 //0.012 0.015
float tarremote = 0.065;//0.095 0.065
//////////////////////////////////////////////////
...
float gyroX_Earth = 0.0;
float gyroY_Earth = 0.0;
float gyroZ_Earth = 0.0;
     float velocity_northf = 0.0;
     float velocity_eastf = 0.0;
//float vz = 0.0;
//kalman
float x1_xt = 0.0;
float y1_xt = 0.0;
...
float GPS_LAT1 = 0.0;
float GPS_LON1 = 0.0;
float GPS_LAT1f = 13.868180;
float GPS_LON1f = 100.496297;
